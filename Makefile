...
#                                                 +#+#+#+#+#+   +#+            #
#    Created: 2018/06/07 12:09:30 by kpetsany          #+#    #+#              #
#    Updated: 2018/07/01 15:42:29 by kpetsany         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #

NAME = libft.a

CFLAGS = -g -W -Wall -Werror -Wextra

SRC = ft_atoi.c ft_memchr.c ft_putnbr_fd.c ft_striter.c	ft_strnew.c \
...
OBJ = ft_atoi.o ft_memchr.o ft_putnbr_fd.o ft_striter.o ft_strnew.o \
      ft_bzero.o ft_memcmp.o ft_putstr.o ft_striteri.o ft_strnstr.o \
      ft_isalnum.o ft_memcpy.o ft_putstr_fd.o ft_strjoin.o ft_strrchr.o \
      ft_isalpha.o ft_memdel.o ft_strcat.o ft_strlcat.o ft_strsplit.o \
      ft_isascii.o ft_memmove.o ft_strchr.o ft_strlen.o ft_strstr.o \
      ft_isdigit.o ft_memset.o ft_strclr.o ft_strmap.o ft_strsub.o \
      ft_isprint.o ft_putchar.o ft_strcmp.o ft_strmapi.o ft_strtrim.o \
      ft_isspace.o ft_putchar_fd.o ft_strcpy.o ft_strncat.o ft_tolower.o \
